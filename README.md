### Hi there 👋 Меня зовут Наташа

### 👩‍💻 Обо мне
- 😎 Я обладаю 13-летним стажем работы в Санкт-Петербургском политехническом университете (СПбПУ), в отделе повышения квалификации.
  За эти годы я накопила богатый опыт в организации образовательных программ, курсов и тренингов, а также в управлении проектами, направленными на повышение квалификации специалистов.
  Могу простым и доступным языком объяснить даже самые сложные темы и перевести на "обычный язык" что говорят эти заумные программисты.
...
![Vite](https://img.shields.io/badge/Vite-4.x-brightgreen?logo=vite&logoColor=white)
